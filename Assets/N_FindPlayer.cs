...
{
    public abstract class N_FindPlayer : NetworkBehaviour {
    ...
    protected virtual void Start()
    {
        ...
        if (m_AutoTargetPlayer && isLocalPlayer)
        {
            FindAndTargetPlayer();
        }
    ...
    public void FindAndTargetPlayer()
    {
        ...
        var targetObjs = GameObject.FindGameObjectsWithTag("Player");
            foreach(GameObject go in targetObjs)
            {
                if (go.GetComponent<NetworkIdentity>().clientAuthorityOwner != null)
                {
